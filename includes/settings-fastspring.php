...
return apply_filters('woocommerce-gateway-fastspring_settings',
  ...
  array(
    ...
    'title' => array(
      ...
      'type' => 'text',
      'description' => __('Th title which the user sees during checkout. Keep it brief to avoid potential layout issues with icons.', 'woocommerce-gateway-fastspring'),
      'default' => __('Online payment', 'woocommerce-gateway-fastspring'),
      'desc_tip' => false,
    ),
    'description' => array(
      ...
      'default' => __('Pay with credit or debit card, PayPal, Amazon Pay and more', 'woocommerce-gateway-fastspring'),
      'desc_tip' => false,
    ),
    'testmode' => array(

...
return apply_filters('woocommerce-gateway-fastspring_settings',
  ...
  array(
    ...
    'popup' => array(
      'title' => __('Popup', 'woocommerce-gateway-fastspring'),
      'label' => __('Enable popup option', 'woocommerce-gateway-fastspring'),
      'type' => 'checkbox',
      'description' => __('Use popup instead of hosted checkout option.', 'woocommerce-gateway-fastspring'),
      'default' => 'yes',
    ),
    'storefront_path' => array(
      'title' => __('Popup Storefront', 'woocommerce-gateway-fastspring'),
      'type' => 'text',
      'description' => __('The path of your live FastSpring popup storefront (Ex: mystore.onfastspring.com/mypopup-mystore.', 'woocommerce-gateway-fastspring).'),
      'desc_tip' => false,
    ),
    'hosted_storefront_path' => array(
      'title' => __('Hosted Storefront Path', 'woocommerce-gateway-fastspring'),
      'type' => 'text',
      'description' => __('The path of your live FastSpring hosted storefront (Ex: mystore.onfastspring.com/mystore.', 'woocommerce-gateway-fastspring).'),
      'desc_tip' => false,
    ),

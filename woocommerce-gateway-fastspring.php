 ...
 */
define('WC_FASTSPRING_SCRIPT', 'https://d1f8f9xcsvx3ha.cloudfront.net/sbl/0.7.4/fastspring-builder.min.js');
define('WC_FASTSPRING_VERSION', '1.0.0');
...
if (!class_exists('WC_FastSpring')):
  ...
  class WC_FastSpring {
    ...
    protected function __construct() {
      ...
      self::$options = get_option('woocommerce_fastspring_settings', array());
    }
     ...
     */
    static public function get_option($o) {
...
*/
    ...
    public function override_checkout_fields($fields) {
      ...
      if ($this->get_option('billing_address')) {
    ...
    public function check_environment() {
      ...
      $bad = !$this->get_option('access_key') || !$this->get_option('storefront_path') || !$this->get_option('private_key');
